/* ======================
    ...
    (function () {
      ...
      const STORAGE_KEY = "iaid_corporatum_contacts";
      const FIXED_NOTIFY_PHONE = "50684079393";

      const copy = {
        es: {
          documentTitle: "Compartir tarjeta | Eliecer Cordero",
          ...
          iaidMessage: function (name, url) {
            return `Hola ${name}. Te comparto mi tarjeta interactiva de negocios de Eliecer Cordero de Corporatum CR: ${url}`;
          },
          notifyMessage: function (listText) {
            return `Lista de contactos de Corporatum CR:\n\n${listText}`;
          }
        },

        en: {
          documentTitle: "Share card | Eliecer Cordero",
          ...
          iaidMessage: function (name, url) {
            return `Hi ${name}. I am sharing my Eliecer Cordero’s Corporatum CR interactive business card with you: ${url}`;
          },
          notifyMessage: function (listText) {
            return `Corporatum CR contact list:\n\n${listText}`;
          }
        }
      };
      ...
      const COUNTRY_STORAGE = { ISO2: "iaid_corporatum_country", LOCKED: "iaid_corporatum_country_locked" };
      ...
      function getLanguage() {
        const savedLanguage = localStorage.getItem("iaid_corporatum_lang");
      ...
      const MESSAGE_STORAGE = {
        MANUAL_TEXT: "iaid_corporatum_msg_manual",
        EDITED: "iaid_corporatum_msg_edited",
        LOCKED: "iaid_corporatum_msg_locked",
        BAKED_PHONE: "iaid_corporatum_baked_phone",
      };
