...
====================== */
(function () {
    const WHATSAPP_PHONE = "50684079393";
    const EMAIL_ADDRESS = "administracion@corporatumcr.com";
    ...
    function getCurrentLanguage() {
        return localStorage.getItem("iaid_corporatum_lang") === "en" ? "en" : "es";
    }
...
(function () {
    function applyLanguage(language) {
        ...
        localStorage.setItem("iaid_corporatum_lang", selectedLanguage);
    ...
    document.addEventListener("DOMContentLoaded", function () {
        const savedLanguage = localStorage.getItem("iaid_corporatum_lang") === "en" ? "en" : "es";
