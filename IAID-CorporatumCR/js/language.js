...
(function () {
  ...
  function applyLanguage(language) {
    ...
    if (language === "en") {
      ...
      localStorage.setItem("iaid_corporatum_lang", "en");
      ...
      localStorage.setItem("iaid_corporatum_lang", "es");
  ...
  document.addEventListener("DOMContentLoaded", function () {
    const savedLanguage = localStorage.getItem("iaid_corporatum_lang") || "es";
