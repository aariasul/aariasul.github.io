/* ==========================================================================
   IAID SHARED "SHARE YOUR INTER-ACTIVEID" MODULE - JS
   Extracted verbatim from IAID-share.html. Drives the whole Share-your-IAID
   panel: name/country/phone entry, message editing/locking, share via other
   apps, saved names list, and Send IAID/save contact. Used identically
   across all businesses - pair with iaid-share.css and the matching markup.
   ========================================================================== */
    ...
    (function () {
      ...
      const STORAGE_KEY = "iaidSavedContactsText";
      const FIXED_NOTIFY_PHONE = "50660405878";

      const copy = {
        es: {
          documentTitle: "Compartir Inter-ActiveID",
          ...
          iaidMessage: function (name, url) {
            return `Hola ${name}. Te comparto mi Tarjeta Interactiva de Negocios Inter-ActiveID: ${url}`;
          },
          notifyMessage: function (listText) {
            return `Lista de contactos Inter-ActiveID:\n\n${listText}`;
          }
        },

        en: {
          documentTitle: "Share Inter-ActiveID",
          ...
          iaidMessage: function (name, url) {
            return `Hi ${name}. I am sharing my Inter-ActiveID Interactive Business Card with you: ${url}`;
          },
          notifyMessage: function (listText) {
            return `Inter-ActiveID contact list:\n\n${listText}`;
          }
        }
      };
      ...
      const COUNTRY_STORAGE = { ISO2: "iaidCountryIso2", LOCKED: "iaidCountryLocked" };
      ...
      const MESSAGE_STORAGE = {
        MANUAL_TEXT: "iaidMessageManualText",
        EDITED: "iaidMessageManuallyEdited",
        LOCKED: "iaidMessageLocked",
        BAKED_PHONE: "iaidMessageBakedPhone",
      };
