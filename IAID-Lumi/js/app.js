...
====================== */
(function () {
    const WHATSAPP_PHONE = "50683088888";
    const EMAIL_ADDRESS = "chavessancho.carla@gmail.com";

    const messages = {
        es: {
            whatsapp: "Saludos Carla de Lumi RH.\nDeseo saber más.\nMi nombre completo es:\nMi correo es:\nMi celular es:",
            emailSubject: "Carla, por favor contácteme.",
            emailBody: "Mi nombre es:\nMi teléfono es:\nAsunto:"
        },
        en: {
            whatsapp: "Hello Carla from Lumi RH.\nI would like to know more.\nMy full name is:\nMy email is:\nMy phone number is:",
            emailSubject: "Carla, please contact me.",
            emailBody: "My name is:\nMy phone number is:\nSubject:"
        }
    };

    function getCurrentLanguage() {
        return localStorage.getItem("lumiLanguage") === "en" ? "en" : "es";
    }
...
(function () {
    function applyLanguage(language) {
        ...
        localStorage.setItem("lumiLanguage", selectedLanguage);
    ...
    document.addEventListener("DOMContentLoaded", function () {
        const savedLanguage = localStorage.getItem("lumiLanguage") === "en" ? "en" : "es";
