/* ======================
    ...
    (function () {
      ...
      const STORAGE_KEY = "materiaSavedContactsText";
      const FIXED_NOTIFY_PHONE = "50683384172";

      const copy = {
        es: {
          documentTitle: "Compartir tarjeta | César Porras",
          ...
          iaidMessage: function (name, url) {
            return `Hola ${name}. Te comparto mi tarjeta interactiva de negocios de César Porras en Materia Arquitectura: ${url}`;
          },
          notifyMessage: function (listText) {
            return `Lista de contactos de Materia Arquitectura:\n\n${listText}`;
          }
        },

        en: {
          documentTitle: "Share card | César Porras",
          ...
          iaidMessage: function (name, url) {
            return `Hi ${name}. I am sharing my César Porras’ Materia Arquitectura interactive business card with you: ${url}`;
          },
          notifyMessage: function (listText) {
            return `Materia Arquitectura contact list:\n\n${listText}`;
          }
        }
      };
      ...
      const COUNTRY_STORAGE = { ISO2: "materiaCountryIso2", LOCKED: "materiaCountryLocked" };
      ...
      function getLanguage() {
        const savedLanguage = localStorage.getItem("materiaLanguage");
      ...
      const MESSAGE_STORAGE = {
        MANUAL_TEXT: "materiaMessageManualText",
        EDITED: "materiaMessageManuallyEdited",
        LOCKED: "materiaMessageLocked",
        BAKED_PHONE: "materiaMessageBakedPhone",
      };
