(function () {
  ...
  function getIAIDBaseUrl() {
    ...
    return "https://inter-activeid.com/IAID-Inter-ActiveID";
  }
  ...
  window.generateLinks = function generateLinks() {
    ...
    const fixedWhatsappURL = `https://wa.me/${phoneNumber}?text=${encodeURIComponent(base + "/IAID-Inter-ActiveID.pdf")}`;
