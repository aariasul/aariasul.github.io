// FILE: ./js/language.js
// Language selection persistence - Papagayo Brewing Co (PBC)
...
(function () {
  ...
  function applyLanguage(language) {
    ...
    if (language === "en") {
      ...
      localStorage.setItem("iaid_PBC_lang", "en");
      ...
      localStorage.setItem("iaid_PBC_lang", "es");
  ...
  document.addEventListener("DOMContentLoaded", function () {
    const savedLanguage = localStorage.getItem("iaid_PBC_lang") || "es";
