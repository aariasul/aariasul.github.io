/* ======================
    ...
    (function () {
      ...
      const STORAGE_KEY = "iaid_PBC_contacts";
      const FIXED_NOTIFY_PHONE = "50657069033";

      const copy = {
        es: {
          documentTitle: "Compartir tarjeta | Papagayo Brewing Co",
          ...
          iaidMessage: function (name, url) {
            return `Hola ${name}. Te comparto la tarjeta interactiva de negocios de Papagayo Brewing Co: ${url}`;
          },
          notifyMessage: function (listText) {
            return `Lista de contactos Papagayo Brewing Co:\n\n${listText}`;
          }
        },

        en: {
          documentTitle: "Share card | Papagayo Brewing Co",
          ...
          iaidMessage: function (name, url) {
            return `Hi ${name}. I am sharing Papagayo Brewing Co’s interactive business card with you: ${url}`;
          },
          notifyMessage: function (listText) {
            return `Papagayo Brewing Co list:\n\n${listText}`;
          }
        }
      };
      ...
      const COUNTRY_STORAGE = { ISO2: "iaid_PBC_country", LOCKED: "iaid_PBC_country_locked" };
      ...
      function getLanguage() {
        const savedLanguage = localStorage.getItem("iaid_PBC_lang");
      ...
      const MESSAGE_STORAGE = {
        MANUAL_TEXT: "iaid_PBC_msg_manual",
        EDITED: "iaid_PBC_msg_edited",
        LOCKED: "iaid_PBC_msg_locked",
        BAKED_PHONE: "iaid_PBC_baked_phone",
      };
