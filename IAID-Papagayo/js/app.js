...
====================== */
(function () {
    const WHATSAPP_PHONE = "50657069033";
    const EMAIL_ADDRESS = "SOLVERDECR@GMAIL.COM";

    const messages = {
        es: {
            whatsapp: "Hola Papagayo, deseo información sobre:\nMi nombre completo es:\nMi correo es:\nMi celular es:",
            emailSubject: "Juan, por favor contácteme.",
            emailBody: "Mi nombre es:\nMi teléfono es:\nAsunto:"
        },
        en: {
            whatsapp: "Hello Papagayo, I would like information about:\nMy full name is:\nMy email is:\nMy phone number is:",
            emailSubject: "Juan, please contact me.",
            emailBody: "My name is:\nMy phone number is:\nSubject:"
        }
    };

    function getCurrentLanguage() {
        return localStorage.getItem("iaid_PBC_lang") === "en" ? "en" : "es";
    }
...
(function () {
    function applyLanguage(language) {
        ...
        localStorage.setItem("iaid_PBC_lang", selectedLanguage);
    ...
    document.addEventListener("DOMContentLoaded", function () {
        const savedLanguage = localStorage.getItem("iaid_PBC_lang") === "en" ? "en" : "es";
