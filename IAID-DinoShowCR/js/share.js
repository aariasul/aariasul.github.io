/* ======================
   IAID SHARE CONTACT LIST MODULE - DINO SHOW CR
====================== */

(function () {
  "use strict";

  const STORAGE_KEY = "iaid_dinoshowcr_contacts";
  const FIXED_NOTIFY_PHONE = "50688719692";

  const copy = {
    es: {
      documentTitle: "Compartir tarjeta | Dino Show Costa Rica",
      ...
      iaidMessage: function (name, url) {
        return `Hola ${name}. Te comparto mi tarjeta interactiva de negocios de Dino Show Costa Rica: ${url}`;
      },
      notifyMessage: function (listText) {
        return `Lista de contactos de Dino Show Costa Rica:\n\n${listText}`;
      }
    },

    en: {
      documentTitle: "Share card | Dino Show Costa Rica",
      ...
      iaidMessage: function (name, url) {
        return `Hi ${name}. I am sharing Dino Show Costa Rica interactive business card with you: ${url}`;
      },
      notifyMessage: function (listText) {
        return `Dino Show Costa Rica contact list:\n\n${listText}`;
      }
    }
  };
  ...
  const COUNTRY_STORAGE = { ISO2: "iaid_dinoshowcr_country", LOCKED: "iaid_dinoshowcr_country_locked" };
  ...
  function getLanguage() {
    const savedLanguage = localStorage.getItem("iaid_dinoshowcr_lang");
  ...
  /* ======================
     EDITABLE MESSAGE TEXT & PERSISTENCE
  ====================== */

  const MESSAGE_STORAGE = {
    MANUAL_TEXT: "iaid_dinoshowcr_msg_manual",
    EDITED: "iaid_dinoshowcr_msg_edited",
    LOCKED: "iaid_dinoshowcr_msg_locked",
    BAKED_PHONE: "iaid_dinoshowcr_baked_phone",
  };
