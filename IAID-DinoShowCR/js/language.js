// FILE: ./js/language.js
// Language selection persistence - Dino Show Costa Rica (DinoShowCR)
...
(function () {
  ...
  function applyLanguage(language) {
    ...
    if (language === "en") {
      ...
      localStorage.setItem("iaid_dinoshowcr_lang", "en");
      ...
      localStorage.setItem("iaid_dinoshowcr_lang", "es");
  ...
  document.addEventListener("DOMContentLoaded", function () {
    const savedLanguage = localStorage.getItem("iaid_dinoshowcr_lang") || "es";
