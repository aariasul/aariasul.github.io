function generateLinks() {
    ...
    if (phoneNumber) {
        const userWhatsappURL = `https://wa.me/${phoneNumber}?text=https://inter-activeid.com/IAID-Distribuidora-Leon/AS/index.html`;
        const fixedWhatsappURL = `https://wa.me/${phoneNumber}?text=https://inter-activeid.com/IAID-Distribuidora-Leon/AS/IAID-Distribuidora-Leon-Andres-Somarribas.pdf`;
        const fixedURLWhatsappURL = `https://wa.me/50664465263?text=Name: ${encodeURIComponent(personName)}%0APhone: ${encodeURIComponent(phoneNumber)}`;
