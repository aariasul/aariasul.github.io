function generateLinks() {
    ...
    if (phoneNumber) {
        const userWhatsappURL = `https://wa.me/${phoneNumber}?text=https://inter-activeid.com/IAID-Anaia-Accessories/index.html`;
        const fixedWhatsappURL = `https://wa.me/${phoneNumber}?text=https://inter-activeid.com/IAID-Anaia-Accessories/IAID-Anaia-Accessories-Ana-Iris.pdf`;
        const fixedURLWhatsappURL = `https://wa.me/50687104453?text=Name: ${encodeURIComponent(personName)}%0APhone: ${encodeURIComponent(phoneNumber)}`;
