/* ======================
    ...
    (function () {
      ...
      const STORAGE_KEY = "iaid_mgcr_contacts";
      const FIXED_NOTIFY_PHONE = "50683624512";
      ...
      const COUNTRY_STORAGE = { ISO2: "iaid_mgcr_country", LOCKED: "iaid_mgcr_country_locked" };
      ...
      function getLanguage() {
        const savedLanguage = localStorage.getItem("iaid_mgcr_lang");
      ...
      const MESSAGE_STORAGE = {
        MANUAL_TEXT: "iaid_mgcr_msg_manual",
        EDITED: "iaid_mgcr_msg_edited",
        LOCKED: "iaid_mgcr_msg_locked",
        BAKED_PHONE: "iaid_mgcr_baked_phone",
      };
