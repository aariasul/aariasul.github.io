...
====================== */
(function () {
    const WHATSAPP_PHONE = "50683624512";
    const EMAIL_ADDRESS = "migraduacioncr@migraduacioncr.com";
    ...
    function getCurrentLanguage() {
        return localStorage.getItem("iaid_mgcr_lang") === "en" ? "en" : "es";
    }
...
(function () {
    function applyLanguage(language) {
        ...
        localStorage.setItem("iaid_mgcr_lang", selectedLanguage);
    ...
    document.addEventListener("DOMContentLoaded", function () {
        const savedLanguage = localStorage.getItem("iaid_mgcr_lang") === "en" ? "en" : "es";
