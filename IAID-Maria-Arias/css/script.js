function generateLinks() {
    ...
    if (phoneNumber) {
        const userWhatsappURL = `https://wa.me/${phoneNumber}?text=https://inter-activeid.com/IAID-Natassia-Wilson/index.html`;
        const fixedWhatsappURL = `https://wa.me/${phoneNumber}?text=https://inter-activeid.com/IAID-Natassia-Wilson/IAID-Orlando-Arroyo.pdf`;
        const fixedURLWhatsappURL = `https://wa.me/50683364648?text=Name: ${encodeURIComponent(personName)}%0APhone: ${encodeURIComponent(phoneNumber)}`;
...
if ('serviceWorker' in navigator) {
    navigator.serviceWorker.register('/IAID-Natassia-Wilson/service-worker.js')
